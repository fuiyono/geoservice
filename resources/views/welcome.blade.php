  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.html"><span>Geoinmotec</span></a></h1>
          ...
          <div class="col-lg-5 d-flex align-items-stretch" data-aos="fade-right">
            <div class="info">
              <div class="address">
                ...
                <h4>Ubicación:</h4>
                <p>Miguel Hidalgo, Toluca, México 50080</p>
              </div>

              <div class="email">
                <i class="icofont-envelope"></i>
                <h4>Email:</h4>
                <p>contacto@geotecmatica.mx</p>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>Geoinmotec</h3>
              <p>
                Miguel Hidalgo 1120 <br>
                Toluca, México<br><br>
                <strong>Teléfono:</strong> 5527241316<br>
                <strong>Email:</strong> contacto@geotecmatica.mx<br>
              </p>
